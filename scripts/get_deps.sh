...
if [ "$arch" = "aarch64" ] || [ "$arch" = "arm64" ]; then
        ...
        wget -q https://github.com/AlexxIT/go2rtc/releases/download/v1.8.3/go2rtc_linux_arm64
        ...
        wget -q https://github.com/AlexxIT/go2rtc/releases/download/v1.8.3/go2rtc_linux_amd64
        ...
        wget -q https://github.com/AlexxIT/go2rtc/releases/download/v1.8.3/go2rtc_linux_arm
        chmod a+x go2rtc_linux_arm


else
    # Default action if architecture is neither aarch64/arm64 nor x86_64 nor arm
